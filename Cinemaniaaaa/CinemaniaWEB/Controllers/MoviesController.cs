...
namespace CinemaniaWEB.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public IActionResult Action()
        {
            ...
            var movieListAction = movieList.Where(m => m.Genre.ToString() == "Action");
            return View(movieListAction);
        }
        ...
        public IActionResult Thriller()
        {
            ...
            string stringData = response.Content.ReadAsStringAsync().Result;
            IEnumerable<MovieDTO> movieList = JsonConvert.DeserializeObject<List<MovieDTO>>(stringData);
            var movieListThriller = movieList.Where(m => m.Genre.ToString() == "Thriller");
            return View(movieListThriller);
        }
        ...
        public IActionResult Comedy()
        {
            ...
            string stringData = response.Content.ReadAsStringAsync().Result;
            IEnumerable<MovieDTO> movieList = JsonConvert.DeserializeObject<List<MovieDTO>>(stringData);
            var movieListComedy = movieList.Where(m => m.Genre.ToString() == "Comedy");
            return View(movieListComedy);
        }
        ...
        public IActionResult Crime()
        {
            ...
            string stringData = response.Content.ReadAsStringAsync().Result;
            IEnumerable<MovieDTO> movieList = JsonConvert.DeserializeObject<List<MovieDTO>>(stringData);
            var movieListCrime = movieList.Where(m => m.Genre.ToString() == "Crime");
            return View(movieListCrime);
        }
        ...
        public IActionResult Horror()
        {
            ...
            string stringData = response.Content.ReadAsStringAsync().Result;
            IEnumerable<MovieDTO> movieList = JsonConvert.DeserializeObject<List<MovieDTO>>(stringData);
            var movieListHorror = movieList.Where(m => m.Genre.ToString() == "Horror");
            return View(movieListHorror);
        }
